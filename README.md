...
[![Build Status](https://travis-ci.org/crypto-zero/go-binance.svg?branch=master)](https://travis-ci.org/crypto-zero/go-binance)
[![GoDoc](https://godoc.org/github.com/crypto-zero/go-binance?status.svg)](https://godoc.org/github.com/crypto-zero/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/crypto-zero/go-binance)](https://goreportcard.com/report/github.com/crypto-zero/go-binance)
[![codecov](https://codecov.io/gh/crypto-zero/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/crypto-zero/go-binance)
...
```shell
go get github.com/crypto-zero/go-binance/v1
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/crypto-zero/go-binance) for full references.
